...
environment = "prod"                      #value to be prefixed to resources names to differentiate them
bucket_name = "terraform-bucket-ycit021" # Put the desired GCS Bucket name.

#Network related

network_cidr_range = "10.128.3.0/26"

pods_cidr_range = "172.2.0.0/18"
pods_cidr_name  = "pod-d"

services_cidr_range = "172.12.0.0/21"
services_cidr_name  = "serv-d"

master_ipv4_cidr_block_range = "172.16.0.32/28"
